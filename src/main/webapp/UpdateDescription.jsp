...
<div class="page-wrapper">
  ...
  <form action="UpdateDescriptionBController" method="post">
  <p><strong>Project ID:</strong> ${project.projectId}</p>
  <input type="hidden" name="projectId" value="${project.projectId}">
<strong>Title:</strong> ${project.title}<br><br>
  <strong>Description:</strong> 
  <input type="text" name="description" class="form-control mb-3" value="${project.description}">
  <strong>Active:</strong> ${project.active} 
 
  

  <div class="mt-4 d-flex gap-3 justify-content-center flex-wrap">

    <button type="submit" class="btn btn-outline-info" style="text-decoration: None">✏️ Change Description</button>
  </div>
  </form>
</div>
